...
<div className="container">
  <div className="row">
    ...
    faqs: [
      {
        question:
          "How will social media marketing work for my type of business?",
        answer: `
        <p>Social media platforms are utilized every day by most individuals around the world. Numerous consumers search out a brand's social media pages or profile prior to buying something. Our proficiency lies in our ability to comprehend your business, discover and develop a targeted following, and drive leads and sales for your business.
        </p>`,
      },
      {
        question:
